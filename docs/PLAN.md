...
**Plan version:** 2.19 · created 2026-09-08 · last amended 2026-09-17
**Status:** Phases 0, 1a, 2, 3, 4, 5, 6, 7, 8, **9** and 12 complete · **Phase 9 measured rather than asserted (2026-09-17): Lighthouse mobile 98–99, accessibility 100, zero axe-core violations** · Phase 10 is next (§13) · Phase 1b unblocked (the VPS is bought — OVHcloud, Warsaw)
...
*Since 2026-09-16 there is a second route:* with `TELEGRAM_BOT_WEBHOOK_URL` set, the same four events
...
| Telegram bot? | ✅ Yes — order, payment, message and review notifications; since 2026-09-16 they can go through the shop's own bot service (§17 #206) |
