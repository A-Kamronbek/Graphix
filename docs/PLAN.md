...
**Plan version:** 2.34 · created 2026-09-08 · last amended 2026-09-23
...
| 14 Owner changes | 🟨 In progress | `phase-14-owner` | 2026-09-21 | — | Five changes the owner asked for after seeing the site live (§17 #250): panel-managed slide cards replacing the hero (#251), required-field marks, sizes and payment methods on the panel’s reference screens, the address split into map and sheet (#252), and four payment methods on `tolov` (#253). Runs before Phase 10 so its tests are written once, against the pages that will ship. **Item 3 done 2026-09-22:** sizes and payment methods edit from the settings screen, through the allowlist that was already there. Two defects on the way, both invisible to the screen itself (§17 #254, #255). **Item 2 done 2026-09-22:** the checkout marks the six fields it will refuse to do without, and says once what the mark means (§17 #256). **Item 1 done 2026-09-22:** the home page leads with panel-managed slide cards and the hero is gone (§17 #257—#259). **Item 4 done 2026-09-22:** with the map chosen the page carries the map and a one-line address that opens a sheet holding the fields (§17 #260). **Item 5 begun 2026-09-22:** Click moves off `click-pkg` onto `tolov` with nothing a customer sees changed, and three defects came with it (§17 #261—#263). **Item 5 done 2026-09-22:** Payme and Octo built and shipped switched off until their credentials exist (§17 #264). **All five items built. 780 tests.** **Item 5 hardened 2026-09-23:** a gateway that refuses now costs the customer a retry instead of 500ing the checkout, Boshqaruv says whether a switched-on method actually has credentials behind it, and Octo pay links follow DEBUG into test mode rather than quietly billing real cards from a laptop (§17 #266). **804 tests.** Outstanding: one photographed pass over the home page and the checkout, and the owner’s Payme and Octo keys |
