...
**Plan version:** 2.7 · created 2026-09-08 · last amended 2026-09-14
**Status:** Phases 0, 1a, 2, 3, 4, 5, 6 and 12 complete · Phase 1b unblocked (the VPS is bought) · **Phase 7 (admin panel) next**, per the §13 order
...
| 12 Reviews | ✅ Done | `phase-12-reviews` | 2026-09-14 | 2026-09-14 | All eight items but the SMS link, which is blocked on Eskiz body moderation (§17 #104) — the account area carries the entry points instead. Eligibility, moderation, EXIF-stripped photos, the distribution, the lightbox and the JSON-LD. 197 tests. Six defects the harnesses found, four of them in the harnesses themselves (§17 #122–#128) |
