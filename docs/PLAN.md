...
**Plan version:** 2.26 · created 2026-09-08 · last amended 2026-09-21
...
| 14 Owner changes | 🟨 In progress | `phase-14-owner` | 2026-09-21 | — | Five changes the owner asked for after seeing the site live (§17 #250): panel-managed slide cards replacing the hero (#251), required-field marks, sizes and payment methods on the panel’s reference screens, the address split into map and sheet (#252), and four payment methods on `tolov` (#253). Runs before Phase 10 so its tests are written once, against the pages that will ship |
