...
**Plan version:** 2.21 · created 2026-09-08 · last amended 2026-09-18
...
| 1b Deployment | 🟨 In progress | `phase-1b-deploy` | 2026-09-18 | — | **Moved ahead of Phase 10 on 2026-09-18 (§17 #238).** Target box **57.128.240.51** (OVHcloud) — it is serving valleymade.uz over HTTPS today and refuses Kamronbek's current SSH key, which is what an older machine looks like, so **§19 Q36 is open** and nothing is installed until it is answered. Deployed alongside, never over (§17 #241). graphix.uz resolves to 45.138.159.4 via `ns1/ns2.eskiz.uz` — the A record is changed at Eskiz, not created |
